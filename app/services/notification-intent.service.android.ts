...
android.app.job.JobService.extend("io.onelessphone.remotecallsmsreader.NotificationIntentService", {
...
try{
        ...
        const mainIntent = new android.content.Intent(context, io.onelessphone.remotecallsmsreader.MainActivity.class); 
